...
int main() {
    ...
    OS_TaskCreate(&main_GreenBlinky, OS_NULL, stack_GreenBlink, sizeof(stack_GreenBlink), 90U);

    OS_TaskCreate(&main_BlueBlinky, OS_NULL, stack_BlueBlink, sizeof(stack_BlueBlink), 35U);
